 ...
 * @param {string|function} options.color - Chalk color string or function to apply (default: 'cyan')
...
function generateASCII(word, options = {}) {
  ...
  // Apply color if specified - support both string and function
  const coloredLines = color 
    ? lines.map((line) => typeof color === 'function' ? color(line) : chalk[color](line))
    : lines;
